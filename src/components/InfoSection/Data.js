export const homeObjOne = {
    ...
    buttonLabel: 'Empieza',
    imgStart: false,
    img: require('../../images/vent1.svg').default,
    alt:'svg',
    dark: true,
    primary: true,
    darkText:false
...
export const homeObjTwo = {
    ...
    description: 'Soy técnico profesional de desarrollo de software, estoy estudiando una tecnología en sistematización de datos en la misma institución. Tengo nivel B1 de inglés realizado en enero del 2022.',
    buttonLabel: 'Empieza',
    imgStart: true,
    img: require('../../images/vent2.svg').default,
    alt:'svg2',
    dark: false,
    primary: false,
    darkText:true
...
export const homeObjThree = {
    ...
    buttonLabel: 'Empieza',
    imgStart: false,
    img: require('../../images/vent4.svg').default,
    alt:'svg',
    dark: false,
    primary: false,
    darkText:true
